...
test("root-invoked build uses crash-recoverable transactional publish without touching root lib", async () => {
  ...
  try {
    ...
    assert.deepEqual(workbenchFiles.map(([path]) => path).sort(), [
      ...
      "client/api.js",
      "client/assets.js",
      "client/automation-detail.js",
      "client/automation-editor.js",
      "client/automation-list.js",
      "client/brand.js",
      "client/capability-library.js",
      ...
      "host/capability-resolver.js",
      "host/capability-service.js",
      "host/chat-preset.js",
      "host/diagnostics.js",
      "host/http.js",
      "host/mode-service.js",
      "host/notification-service.js",
      ...
      "shared/automation-contracts.js",
      "shared/capabilities.js",
      "shared/capability-manifest.js",
