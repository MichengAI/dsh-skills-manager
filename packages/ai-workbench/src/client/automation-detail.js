...
export function createAutomationDetail(React, options = {}) {
  ...
  return function AutomationDetail({ item, onClose, workbench } = {}) {
    ...
    return h("div", { className: "daw-automation-detail", role: "dialog", "aria-modal": "true", "aria-labelledby": "daw-automation-detail-title" }, [
      h("div", { className: "daw-dialog-header", key: "header" }, [h("h2", { id: "daw-automation-detail-title", key: "title" }, item.name), h("button", { type: "button", className: "daw-dialog-close", onClick: onClose, "aria-label": "关闭", key: "close" }, "×")]),
