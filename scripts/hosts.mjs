...
export const supportedHosts = Object.freeze(["0.1.0-rc.8", "0.1.1-rc.2", "0.1.2-rc.1", "0.1.5-rc.1", "0.1.5-rc.2", "0.1.7-rc.1", "0.1.7-rc.2"]);
export const peerRange = supportedHosts.join(" || ");
export const developmentHost = "0.1.7-rc.2";
