    ...
    factory: (require2) => {
      ...
      var DICT = {
        zh: {
          ...
          "scope.projectHint": "\u4EC5\u5728\u6240\u9009\u9879\u76EE\u4E2D\u751F\u6548\u3002\u542F\u505C\u4E0D\u4FEE\u6539\u5176\u4ED6 Agent \u7684\u6E90\u6587\u4EF6\u3002\u5BFC\u5165\u4ECD\u5199\u5165\u5168\u5C40 DSH\u3002",
          "project.select": "\u9009\u62E9\u9879\u76EE",
        ...
        en: {
          ...
          "scope.projectHint": "Applies to the selected project. Toggles do not modify other agents\u2019 source files. Import still writes to global DSH.",
      ...
      var CSS2 = `
.dssm-tabs{display:flex;gap:24px;border-bottom:1px solid var(--dsw-alias-border-l2)}.dssm-tab{padding:12px 2px;border:0;border-bottom:2px solid transparent;background:transparent;color:var(--dsw-alias-label-secondary);font:inherit;font-weight:600;cursor:pointer}.dssm-tab[aria-selected=true]{border-bottom-color:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary)}.dssm-tab:focus-visible{outline:2px solid var(--dsw-alias-state-success-primary);outline-offset:2px}.dssm-project-picker{display:grid;gap:8px;min-width:0}.dssm-source-controls{display:flex;align-items:center;justify-content:space-between;gap:12px;min-width:0}.dssm-status-filter{width:140px;flex:none}.dssm-sources{border:1px solid var(--dsw-alias-border-l2);border-radius:10px;overflow:hidden}.dssm-source-controls .dssm-context-path{flex:1}.dssm-context-path{display:block;min-width:0;white-space:normal;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.dssm-note{overflow-wrap:anywhere}.dssm-row .dssm-name{overflow-wrap:anywhere}
...
.dssm-summary{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));overflow:hidden;border:1px solid var(--dsw-alias-border-l2);border-radius:10px;background:var(--dsw-alias-bg-layer-2)}.dssm-stat{padding:12px 14px;border-right:1px solid var(--dsw-alias-border-l1);font-size:13px;color:var(--dsw-alias-label-secondary)}.dssm-stat:last-child{border-right:0}.dssm-stat strong{margin-right:5px;color:var(--dsw-alias-label-primary);font-size:17px;font-weight:680}.dssm-filters{display:flex;gap:9px}.dssm-search{flex:1}.dssm-source-filter{width:210px;flex:none}
...
.dssm-sources{display:flex;flex-direction:column}.dssm-row:hover,.dssm-trash-row:hover{background:var(--dsw-alias-interactive-bg-hover)}.dssm-count{color:var(--dsw-alias-label-tertiary);font-size:12px}.dssm-path{min-width:0;margin-left:auto;overflow:hidden;color:var(--dsw-alias-label-tertiary);font-size:11px;text-overflow:ellipsis;white-space:nowrap}
...
@container(max-width:780px){.dssm-table-head{display:none}.dssm-row{grid-template-columns:minmax(0,1fr) max-content;gap:8px;padding:11px 13px}.dssm-row>.dssm-tags,.dssm-row>.dssm-status{grid-column:1}.dssm-row-actions{grid-column:2;grid-row:1 / span 3}.dssm-path{display:none}}@media(max-width:760px){.dssm-summary{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:720px){.dssm-title-row{flex-wrap:wrap}}@container(max-width:520px){.dssm-head{flex-direction:column}.dssm-actions{width:100%;margin-left:0}.dssm-actions .dssm-btn{flex:1}.dssm-filters{flex-direction:column}.dssm-source-filter{width:100%}.dssm-summary{grid-template-columns:1fr}}
`;
      ...
      function nextScopeTab(current, key) {
        if (key === "Home") return "user";
        if (key === "End") return "project";
        if (key === "ArrowLeft" || key === "ArrowUp") return current === "project" ? "user" : "user";
        if (key === "ArrowRight" || key === "ArrowDown") return current === "user" ? "project" : "project";
        return current;
      }
      ...
      function SkillManagerSection(props) {
        ...
        function renderSkill(root, skill) {
          ...
          return h("div", { key: root.key + ":" + skill.name, className: "dssm-row" }, h("div", { className: "dssm-main" }, h("div", { className: "dssm-name" }, skill.declaredName || skill.name), h("div", { className: "dssm-note" }, skill.description || t("note.missing"))), h("div", { className: "dssm-tags" }, h("span", { className: "dssm-tag", title: root.path }, t("root." + (root.localeKey || root.key))), !root.mutable ? h("span", { className: "dssm-tag" }, t("status.readonly")) : null), h("div", { className: "dssm-status " + cls, title: skill.shadowedBy ? t("status.shadowedBy", { source: function() {
          ...
          }() }) : void 0 }, t(key)), h("div", { className: "dssm-row-actions" }, root.toggleable !== false ? h(Switch, { on: enabled, disabled: busy || root.enabled === false || !!skill.shadowedBy || skill.loadable === false, label: t("skill.toggle") + " " + skill.name, onClick: function() {
        ...
        })), onChange: setSelectedProject }), activeProject ? h("div", { className: "dssm-context-path", title: activeProject }, activeProject) : null) : null;
        var sourceControls = h("div", { key: "source-controls", className: "dssm-source-controls" }, selectedRoot ? h(react.Fragment, null, h("span", { className: "dssm-context-path", title: selectedRoot.path }, selectedRoot.path), canToggleSource(selectedRoot) ? h(Switch, { on: selectedRoot.enabled, disabled: busy, label: t("source.toggle") + " " + rootDisplayName(t, selectedRoot), onClick: function() {
        ...
        var content = [h("style", { key: "css" }, CSS2), h("div", { key: "head", className: "dssm-head" }, h("div", { className: "dssm-title-block" }, h("div", { className: "dssm-title-row" }, h("h2", { className: "dssm-title" }, t("title")), h("div", { className: "dssm-feedback-links" }, h("a", { className: "dssm-feedback-link", href: "https://github.com/MichengAI/dsh-skills-manager", target: "_blank", rel: "noreferrer", "aria-label": t("link.project") }, h(GithubMark16, null), t("link.project")), h("a", { className: "dssm-feedback-link", href: "https://github.com/MichengAI/dsh-skills-manager/issues", target: "_blank", rel: "noreferrer", "aria-label": t("link.feedback") }, h(primitives.IconListPenOutline16, null), t("link.feedback")))), h("p", { className: "dssm-desc" }, t("desc"))), h("div", { className: "dssm-actions" }, h("button", { type: "button", className: "dssm-btn dssm-btn-secondary", disabled: busy || snapshot.loading, onClick: function() {
          ...
          setUpload(null);
          setModal("import");
        } }, t("import.global")))), tabs, projectPicker, h("p", { key: "scope-hint", className: "dssm-note" }, t(scope === "project" ? "scope.projectHint" : "scope.userHint")), h("div", { key: "summary", className: "dssm-summary" }, [["total", "summary.total"], ["enabled", "summary.enabled"], ["disabled", "summary.disabled"], ["shadowed", "summary.shadowed"], ["invalid", "summary.invalid"]].map(function(item) {
