...
`;
      ...
      function SkillManagerSection(props) {
        ...
        var sourceControls = h("div", { key: "source-controls", className: "dssm-source-controls" }, selectedRoot ? h(react.Fragment, null, h("span", { className: "dssm-path", title: selectedRoot.path }, selectedRoot.path), canToggleSource(selectedRoot) ? h(Switch, { on: selectedRoot.enabled, disabled: busy, label: t("source.toggle") + " " + rootDisplayName(t, selectedRoot), onClick: function() {
