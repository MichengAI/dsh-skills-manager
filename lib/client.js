    ...
    function SkillManagerSection() {
      ...
      function skillRow(skill, root) {
        ...
        return h("div", { key: skill.name, className: "dssm-row" },
          ...
          h("button", { className: "dssm-btn dssm-btn-secondary", disabled: !!busy, onClick: function () { action(enabled ? "/disable" : "/enable", { name: skill.name, root: root.key }); } }, enabled ? "停用" : "启用"),
