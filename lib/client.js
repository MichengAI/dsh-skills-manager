...
`;
  ...
  window.__ModuleLoader__.load({
    ...
    factory: (require2) => {
      ...
      var CSS2 = `
.dssm-tabs{display:flex;gap:24px;border-bottom:1px solid var(--dsw-alias-border-l2)}.dssm-tab{display:inline-flex;align-items:center;gap:6px;white-space:nowrap;padding:12px 2px;border:0;border-bottom:2px solid transparent;background:transparent;color:var(--dsw-alias-label-secondary);font:inherit;font-weight:600;cursor:pointer}.dssm-tab[aria-selected=true]{border-bottom-color:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary)}.dssm-tab:focus-visible{outline:2px solid var(--dsw-alias-state-success-primary);outline-offset:2px}.dssm-project-picker{display:grid;gap:8px;min-width:0}.dssm-source-controls{display:flex;align-items:center;justify-content:space-between;gap:12px;min-width:0}.dssm-status-filter{width:140px;flex:none}.dssm-sources{border:1px solid var(--dsw-alias-border-l2);border-radius:10px;overflow:hidden}.dssm-source-controls .dssm-context-path{flex:1}.dssm-context-path{display:block;min-width:0;white-space:normal;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.dssm-note{overflow-wrap:anywhere}.dssm-fallback{margin-top:4px;color:var(--dsw-alias-label-secondary)}.dssm-row .dssm-name{overflow-wrap:anywhere}
...
@container(max-width:780px){.dssm-table-head{display:none}.dssm-row{grid-template-columns:minmax(0,1fr) max-content;gap:8px;padding:11px 13px}.dssm-row>.dssm-tags,.dssm-row>.dssm-status{grid-column:1}.dssm-row-actions{grid-column:2;grid-row:1 / span 3}}@media(max-width:760px){.dssm-summary{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:720px){.dssm-title-row{flex-wrap:wrap}}@container(max-width:520px){.dssm-tabs{gap:16px}.dssm-trash-item{flex-wrap:wrap}.dssm-trash-main{flex-basis:100%}.dssm-head{flex-direction:column}.dssm-actions{width:100%;margin-left:0}.dssm-actions .dssm-btn{flex:1}.dssm-filters{flex-direction:column}.dssm-source-filter{width:100%}.dssm-summary{grid-template-columns:1fr}}
`;
      ...
      function SkillManagerSection(props) {
        ...
        function renderSkill(root, skill) {
          ...
          return h("div", { key: root.key + ":" + skill.name, className: "dssm-row" }, h("div", { className: "dssm-main" }, h("div", { className: "dssm-name" }, skill.declaredName || skill.name), h("div", { className: "dssm-note" }, skill.description || t("note.missing")), renderFallback(skill)), h("div", { className: "dssm-tags" }, h("span", { className: "dssm-tag", title: root.path }, t("root." + (root.localeKey || root.key))), !root.mutable ? h("span", { className: "dssm-tag" }, t("status.readonly")) : null), h("div", { className: "dssm-status " + cls, title: skill.shadowedBy ? t("status.shadowedBy", { source: function() {
        ...
        var skillControls = [projectPicker, h("p", { key: "scope-hint", className: "dssm-note" }, t(scope === "project" ? "scope.projectHint" : "scope.userHint")), h("div", { key: "summary", className: "dssm-summary" }, [["total", "summary.total"], ["enabled", "summary.enabled"], ["disabled", "summary.disabled"], ["shadowed", "summary.shadowed"], ["invalid", "summary.invalid"]].map(function(item) {
        ...
        var content = [h("style", { key: "css" }, CSS2), h("div", { key: "head", className: "dssm-head" }, h("div", { className: "dssm-title-block" }, h("div", { className: "dssm-title-row" }, h("h2", { className: "dssm-title" }, t("title")), h("div", { className: "dssm-feedback-links" }, h("a", { className: "dssm-feedback-link", href: "https://github.com/MichengAI/dsh-skills-manager", target: "_blank", rel: "noreferrer", "aria-label": t("link.project") }, h(GithubMark16, null), t("link.project")), h("a", { className: "dssm-feedback-link", href: "https://github.com/MichengAI/dsh-skills-manager/issues", target: "_blank", rel: "noreferrer", "aria-label": t("link.feedback") }, h(primitives.IconListPenOutline16, null), t("link.feedback")))), h("p", { className: "dssm-desc" }, t("desc"))), h("div", { className: "dssm-actions" }, h("button", { type: "button", className: "dssm-btn dssm-btn-secondary", disabled: busy || snapshot.loading, onClick: function() {
          refresh(false);
        } }, t("btn.refresh")), scope !== "trash" ? h("button", { type: "button", className: "dssm-btn", disabled: busy || !createRoots.length, onClick: openCreate }, t("btn.create")) : null, scope !== "trash" ? h("button", { type: "button", className: "dssm-btn dssm-btn-secondary", onClick: function() {
          setResult(null);
          setUpload(null);
          setModal("import");
