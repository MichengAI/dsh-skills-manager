        ...
        return enqueueMutation(() => {
          switch (path) {
            case "/api/dsh-skills-manager/enable":
              return run(res, () => setSkillEnabled(rootByKey[String(body.root || "dsh")], String(body.name || ""), true), afterWrite);
            case "/api/dsh-skills-manager/disable":
              return run(res, () => setSkillEnabled(rootByKey[String(body.root || "dsh")], String(body.name || ""), false), afterWrite);
            case "/api/dsh-skills-manager/delete":
              return run(res, () => deleteSkill(rootByKey.dsh, String(body.name || ""), log), afterWrite);
